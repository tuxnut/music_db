...
<body>
    ...
    <div id="editComposer" class="modal">
        ...
        <form class="modal-content animate" action="/updateComposer" method="POST">
            <div id="editionForm" class="formContainer">
                ...
                <button type="button" onclick="document.getElementById('editComposer').style.display='none'" class="cancelbtn clickable">Annuler</button>
            </div>
        </form>
    </div>
